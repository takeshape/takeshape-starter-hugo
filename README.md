# TakeShape Starter Hugo

The following is a guide to launching a Hugo TakeShape project that injects Ecommerce data into your components.
...
4. In the terminal on your local machine, clone this repo with `git clone https://github.com/takeshape/takeshape-starter-hugo`.

5. Open the project in your favorite IDE or change directories into it with your terminal.

5. Edit `createData.js` in the `buildscripts` directory and replace the text that says `YOUR-ENDPOINT-HERE` with your API Endpoint. Replace the text that says `YOUR-API-KEY-HERE` with your API Key.
...
Check out [our docs on this project](https://app.takeshape.io/docs/get-started/ssg/hugo) to learn how this example works.